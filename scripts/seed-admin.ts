...
const ADMIN_SEED_EMAIL = process.env.ADMIN_SEED_EMAIL || 'admin@nucleux.academy';
const ADMIN_SEED_NAME = process.env.ADMIN_SEED_NAME || 'Admin User';

if (!SUPABASE_URL || !SERVICE_ROLE_KEY || !ADMIN_SEED_PASSWORD) {
  console.error('❌ Missing required environment variables:');
  if (!SUPABASE_URL) console.error('   - NEXT_PUBLIC_SUPABASE_URL');
  if (!SERVICE_ROLE_KEY) console.error('   - SUPABASE_SERVICE_ROLE_KEY');
  if (!ADMIN_SEED_PASSWORD) console.error('   - ADMIN_SEED_PASSWORD');
