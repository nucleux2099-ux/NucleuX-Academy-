...
export function Header() {
  return (
    <header className="h-16 border-b border-[#1E293B] bg-[#0F172A]/80 backdrop-blur-sm sticky top-0 z-30">
      <div className="h-full px-6 flex items-center justify-between gap-4">
        {/* Search */}
        <div className="flex-1 max-w-xl ml-16 lg:ml-0">
          <div className="relative">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#94A3B8]" />
            <Input
              placeholder="Search topics, notes, questions..."
              className="pl-10 bg-[#1E293B] border-[#334155] focus:border-[#7C3AED] focus:ring-[#7C3AED]/20"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-3 p-1 rounded-lg hover:bg-[#1E293B] transition-colors">
