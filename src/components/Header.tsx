...
export function Header() {
  ...
  return (
    <header className="h-14 sm:h-16 border-b border-[rgba(232,224,213,0.08)] bg-[#2D3E50]/95 backdrop-blur-sm sticky top-0 z-30">
      <div className="h-full px-4 sm:px-6 flex items-center justify-between gap-2 sm:gap-4">
        {/* Logo on mobile */}
        <div className="lg:hidden flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#5BB3B3] to-[#4A9E9E] flex items-center justify-center shadow-matte">
        ...
        <div className="flex-1 max-w-xl">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-[#3A4D5F] border-[rgba(232,224,213,0.1)] focus:border-[#5BB3B3] focus:ring-[#5BB3B3]/20 h-9 sm:h-10 text-sm text-[#E8E0D5] placeholder:text-[#A0B0BC]"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {/* Notifications */}
          <Link href="/notifications" className="relative p-2 rounded-xl hover:bg-[rgba(232,224,213,0.05)] transition-colors border border-transparent hover:border-[rgba(232,224,213,0.1)]">
            <Bell className="w-5 h-5 text-[#A0B0BC] hover:text-[#E8E0D5] transition-colors" />
            <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[#C9A86C] rounded-full ring-2 ring-[#2D3E50]" />
          </Link>

          {/* Settings - hide on mobile */}
          <Link href="/settings" className="hidden sm:block p-2 rounded-xl hover:bg-[rgba(232,224,213,0.05)] transition-colors border border-transparent hover:border-[rgba(232,224,213,0.1)]">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-2 sm:gap-3 p-1.5 rounded-xl hover:bg-[rgba(232,224,213,0.05)] transition-colors border border-transparent hover:border-[rgba(232,224,213,0.1)]">
            ...
            <DropdownMenuContent
              align="end"
              className="w-56 bg-[#364A5E] border-[rgba(232,224,213,0.1)] shadow-matte-lg"
            >
