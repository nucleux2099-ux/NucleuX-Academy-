    ...
    return (
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        <Card className="bg-[#364A5E] border-[rgba(91,179,179,0.15)] overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-r from-[rgba(91,179,179,0.15)] to-[rgba(201,168,108,0.12)] p-8 text-center border-b border-[rgba(91,179,179,0.1)]">
          ...
          <CardContent className="p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className="p-4 rounded-xl bg-[#3A4D5F] text-center">
                ...
                <p className="text-2xl font-bold text-[#C9A86C]">{formatTime(timeElapsed)}</p>
            ...
            {Object.keys(calibrationData).length > 0 && (
              <div className="mb-8">
                <h3 className="text-lg font-semibold text-[#E8E0D5] mb-4 flex items-center gap-2">
                  <Brain className="w-5 h-5 text-[#C9A86C]" />
        ...
        <CardHeader>
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {question.pyq && (
                <Badge className="bg-[rgba(201,168,108,0.18)] text-[#C9A86C] border-none">
          ...
          {showConfidenceSelector && !showExplanation && selectedAnswer !== null && (
            <div className="p-4 rounded-lg bg-[#3A4D5F] border border-[rgba(91,179,179,0.1)]">
              <p className="text-sm text-[#A0B0BC] mb-3 flex items-center gap-2">
                <Brain className="w-4 h-4 text-[#C9A86C]" />
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="text-[#C9A86C] hover:text-[#D8BE90] hover:bg-[#C9A86C]/10 gap-1"
                      onClick={() => {
