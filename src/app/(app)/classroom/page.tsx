...
import { Play, Clock, BookOpen, CircleCheck, Filter, Search, User, BarChart3, PenTool, Brain, Mic } from 'lucide-react';
    ...
    <div className="ui-shell ui-page space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link href="/classroom/mindmap">
          <Card className="bg-gradient-to-br from-teal-900/40 to-[#253545] border-teal-500/20 rounded-xl p-5 hover:border-teal-500/40 transition-all cursor-pointer group">
            ...
            <div className="flex gap-2 mt-3">
              ...
              <Badge className="text-[10px] bg-[#C9A86C]/14 text-[#D8BE90] border-[#C9A86C]/24">Viva Mode</Badge>
            </div>
          </Card>
        </Link>
        ...
        <Link href="/classroom/live-ai">
          <Card className="bg-gradient-to-br from-[#364A5E]/95 to-[#2D3E50]/95 border-[#C9A86C]/24 rounded-xl p-5 hover:border-[#C9A86C]/35 transition-all cursor-pointer group">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 rounded-lg bg-[#C9A86C]/16"><Mic size={20} className="text-[#C9A86C]" /></div>
              <div>
                <h3 className="font-semibold text-[#E8E0D5] group-hover:text-[#C9A86C] transition-colors">Live AI Class</h3>
                <p className="text-xs text-[#A0B0BC]">Voice-powered teaching in Telugu, Hindi, English</p>
              </div>
            </div>
            <div className="flex gap-2 mt-3">
              <Badge className="text-[10px] bg-[#C9A86C]/14 text-[#D8BE90] border-[#C9A86C]/24">Voice</Badge>
      ...
      <div className="flex items-center gap-6 text-sm text-[#A0B0BC]">
        ...
        <div className="flex items-center gap-2"><CircleCheck size={16} className="text-emerald-400" /> <span><strong className="text-[#E8E0D5]">12</strong> Completed</span></div>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2 max-h-[500px] overflow-y-auto pr-1">
            {filtered.map((lecture) => (
              <Card
                key={lecture.id}
                className={`p-3 rounded-xl cursor-pointer transition-all border-[rgba(232,224,213,0.06)] ${lecture.current ? 'bg-[#253545]' : 'bg-[#253545]/60 hover:bg-[#253545]'
                  }`}
