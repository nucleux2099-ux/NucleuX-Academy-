    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="bg-[#142538] border border-zinc-700 rounded-lg p-3">
          ...
          <div className="text-xs text-zinc-500">UG Competencies (OR1–OR14)</div>
        </div>
        <div className="bg-[#142538] border border-zinc-700 rounded-lg p-3">
          <div className="text-2xl font-bold text-blue-400">{ORTHOPEDICS_PG_TOPICS.length}</div>
          <div className="text-xs text-zinc-500">PG Syllabus Topics (MS Orthopedics)</div>
        </div>
        <div className="bg-[#142538] border border-zinc-700 rounded-lg p-3">
          <div className="text-2xl font-bold text-red-400">{ORTHOPEDICS_SS_SPECIALTIES.length}</div>
          <div className="text-xs text-zinc-500">SS Specialties (MCh)</div>
        </div>
        <div className="bg-[#142538] border border-zinc-700 rounded-lg p-3">
          <div className="text-2xl font-bold text-white">{ORTHOPEDICS_SUBSPECIALTIES.length}</div>
      ...
      {tab === "pg" && (
        <div className="space-y-6">
          ...
          <div className="bg-[#0D1B2A] border border-zinc-700/50 rounded p-3 text-sm text-zinc-500">
            <span className="text-blue-400 font-medium">MS Orthopedics</span> — PG syllabus topics grouped by subspecialty.
      ...
      {tab === "ss" && (
        <div className="space-y-6">
          <div className="bg-[#0D1B2A] border border-zinc-700/50 rounded p-3 text-sm text-zinc-500">
            <span className="text-red-400 font-medium">MCh Super Specialties</span> — Each requires MS Orthopedics as prerequisite.
          </div>
          ...
          <div className="bg-[#142538] border border-zinc-700 rounded-lg p-4">
            <h3 className="text-sm font-semibold text-zinc-300 mb-3">Orthopedics Training Progression</h3>
