    ...
    <div className="ui-shell ui-page space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="bg-[#364A5E] border border-[rgba(232,224,213,0.1)] rounded-lg p-3">
          ...
          <div className="text-xs text-[#6B7A88]">UG Competencies (IM1–IM26)</div>
        </div>
        <div className="bg-[#364A5E] border border-[rgba(232,224,213,0.1)] rounded-lg p-3">
          <div className="text-2xl font-bold text-[#8FD5D5]">{MEDICINE_PG_TOPICS.length}</div>
          <div className="text-xs text-[#6B7A88]">PG Syllabus Topics (MD General Medicine)</div>
        </div>
        <div className="bg-[#364A5E] border border-[rgba(232,224,213,0.1)] rounded-lg p-3">
          <div className="text-2xl font-bold text-[#E57373]">{MEDICINE_SS_SPECIALTIES.length}</div>
          <div className="text-xs text-[#6B7A88]">SS Specialties (DM)</div>
        </div>
        <div className="bg-[#364A5E] border border-[rgba(232,224,213,0.1)] rounded-lg p-3">
          <div className="text-2xl font-bold text-[#E8E0D5]">{MEDICINE_SUBSPECIALTIES.length}</div>
      ...
      {tab === "pg" && (
        <div className="space-y-6">
          ...
          <div className="bg-[#2D3E50] border border-[rgba(232,224,213,0.08)] rounded p-3 text-sm text-[#6B7A88]">
            <span className="text-[#8FD5D5] font-medium">MD General Medicine</span> — PG syllabus topics grouped by subspecialty.
      ...
      {tab === "ss" && (
        <div className="space-y-6">
          <div className="bg-[#2D3E50] border border-[rgba(232,224,213,0.08)] rounded p-3 text-sm text-[#6B7A88]">
            <span className="text-[#E57373] font-medium">DM Super Specialties</span> — Each requires MD General Medicine as prerequisite.
          </div>
          ...
          <div className="bg-[#364A5E] border border-[rgba(232,224,213,0.1)] rounded-lg p-4">
            <h3 className="text-sm font-semibold text-[#C8D2DA] mb-3">Medicine Training Progression</h3>
