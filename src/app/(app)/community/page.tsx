    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          <Card key={i} className="bg-[#364A5E] border-[rgba(91,179,179,0.15)]">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="discussions" className="space-y-4">
              {discussions.map((d) => (
                <Card key={d.id} className="bg-[#364A5E] border-[rgba(91,179,179,0.15)] border-l-4 hover:border-[rgba(180,83,9,0.3)] cursor-pointer transition-all" style={{ borderLeftColor: roomColor }}>
            ...
            <TabsContent value="groups" className="grid sm:grid-cols-2 gap-4">
              {studyGroups.map((g) => (
                <Card key={g.id} className="bg-[#364A5E] border-[rgba(91,179,179,0.15)] hover:border-[rgba(180,83,9,0.3)] cursor-pointer transition-all">
        ...
        <div className="space-y-6">
          ...
          {/* ATOM Card */}
          <Card className="bg-gradient-to-br from-[rgba(180,83,9,0.1)] to-[#364A5E] border-[rgba(180,83,9,0.2)]">
            <CardContent className="p-5">
              <div className="flex items-center gap-3 mb-3">
