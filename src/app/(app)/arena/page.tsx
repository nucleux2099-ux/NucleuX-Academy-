    ...
    <div className="ui-shell ui-page space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Badge className="bg-gradient-to-r from-[#364A5E] to-[#2D3E50] text-[#D97706] border-[#C9A86C] px-4 py-2 font-semibold shadow-md">
            <Coins className="w-4 h-4 mr-2" />
            {userCoins.toLocaleString()} Coins
          </Badge>
          <Badge className="border-[#5BB3B3]/25 bg-gradient-to-r from-[#364A5E] to-[#2D3E50] px-4 py-2 font-semibold text-[#5BB3B3] shadow-md">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="daily" className="space-y-6">
          <div className="grid lg:grid-cols-3 gap-6">
            {/* Main Challenge Card */}
            <Card className="lg:col-span-2 bg-gradient-to-br from-[#364A5E] via-[#314458] to-[#2D3E50] border-[rgba(91,179,179,0.15)] shadow-xl overflow-hidden relative">
              ...
              <CardContent className="relative space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <Badge className="border border-[#E57373]/30 bg-[#E57373]/18 text-[#F3B0B0] font-medium">
                      {dailyChallenge.difficulty}
                    </Badge>
                    <Badge className="border border-[#5BB3B3]/28 bg-[#5BB3B3]/18 text-[#8FD5D5] font-medium">
                ...
                <Button className="w-full py-6 bg-gradient-to-r from-[#5BB3B3] to-[#4A9E9E] hover:from-[#4A9E9E] hover:to-[#3F6F8A] text-lg font-semibold shadow-xl shadow-[#5BB3B3]/25 transition-all hover:scale-[1.02]">
            ...
            <Card className="bg-[#364A5E] border-[rgba(91,179,179,0.15)] shadow-lg">
              <CardHeader className="bg-gradient-to-r from-[#364A5E] to-[#2D3E50] border-b border-[#C9A86C]/30 rounded-t-xl">
              ...
              <CardContent className="space-y-4 pt-4">
                {dailyChallenge.topPerformers.map((performer, idx) => (
                  <div
                    key={performer.rank}
                    className="flex items-center gap-4 p-3 rounded-xl bg-[#2D3E50] border border-[rgba(91,179,179,0.15)] hover:shadow-lg transition-all"
                  >
                ...
                <Button variant="outline" className="w-full border-[rgba(91,179,179,0.15)] hover:bg-[#2D3E50] text-[#A0B0BC]">
                  View All Rankings
                </Button>
              </CardContent>
            </Card>
            ...
            <CardContent>
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="p-4 rounded-xl bg-[#2D3E50] border border-[rgba(91,179,179,0.15)] hover:border-[#5BB3B3]/30 hover:shadow-lg cursor-pointer transition-all"
                  >
        ...
        <TabsContent value="tournament" className="space-y-6">
          {/* Tournament Banner */}
          <Card className="bg-gradient-to-r from-[#364A5E] via-[#314458] to-[#2D3E50] border-[rgba(91,179,179,0.22)] shadow-xl overflow-hidden relative">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div className="flex flex-col items-center gap-4">
                  {weeklyTournament.userProgress.qualified ? (
                    ...
                    <Badge className="border border-[#E57373]/30 bg-[#E57373]/16 px-6 py-2 text-[#F3B0B0]">
                      Not Qualified Yet
                    </Badge>
                  )}
                  <Button className="bg-gradient-to-r from-[#5BB3B3] to-[#4A9E9E] hover:from-[#4A9E9E] hover:to-[#3F6F8A] px-8 shadow-xl shadow-[#5BB3B3]/25">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <Card className="bg-[#364A5E] border-[rgba(91,179,179,0.15)] shadow-lg">
              ...
              <CardContent className="space-y-6 pt-6">
                <div className="text-center py-4 bg-gradient-to-br from-[#364A5E] to-[#2D3E50] rounded-2xl">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between p-3 bg-[#2D3E50] rounded-lg">
                ...
                <div className="p-4 rounded-xl border border-[rgba(91,179,179,0.2)] bg-gradient-to-r from-[#364A5E]/80 to-[#2D3E50]/80">
                ...
                {weeklyTournament.schedule.map((phase) => (
                  <div
                    ...
                    className={`flex items-center gap-4 p-4 rounded-xl border ${
                      phase.status === "active"
                        ? "bg-gradient-to-r from-[#364A5E] to-[#2D3E50] border-[#5BB3B3]/30 shadow-lg"
                        : "bg-[#2D3E50] border-[rgba(91,179,179,0.15)]"
                    }`}
                  >
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center shadow-md ${
                        phase.status === "active" ? "bg-[#5BB3B3] text-white" : "bg-[#3A4D5F]"
                      }`}
                    >
                      {phase.status === "active" ? (
            ...
            <Card className="bg-[#364A5E] border-[rgba(91,179,179,0.15)] shadow-lg">
              ...
              <CardContent className="space-y-4 pt-4">
                {weeklyTournament.prizes.map((prize, idx) => (
                  <div
                    key={prize.rank}
                    className="flex items-center gap-4 p-4 rounded-xl bg-[#2D3E50] border border-[rgba(91,179,179,0.15)] hover:shadow-lg transition-all"
                  >
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-md ${
                        idx === 0
                          ? "bg-gradient-to-br from-[#C9A86C] to-[#8F7650]"
                          : idx === 1
                          ? "bg-gradient-to-br from-[#A0B0BC] to-[#6B7A88]"
                          : idx === 2
                          ? "bg-gradient-to-br from-[#FED7AA] to-[#EA580C]"
                          : "bg-gradient-to-br from-[#4A5E73] to-[#5BB3B3]"
                      }`}
                    >
                      <prize.icon
                        className={`w-6 h-6 ${
        ...
        <TabsContent value="leaderboard" className="space-y-6">
              ...
              <Button
                ...
                className={
                  leaderboardTab === tab.id
                    ...
                    : "border-[rgba(91,179,179,0.15)] hover:bg-[#2D3E50] text-[#A0B0BC]"
                }
          ...
          <Card className="bg-[#364A5E] border-[rgba(91,179,179,0.15)] shadow-lg overflow-hidden">
            <CardContent className="p-0">
              {/* Table Header */}
              <div className="grid grid-cols-12 gap-4 p-4 border-b border-[rgba(91,179,179,0.15)] text-sm text-[#A0B0BC] bg-[#2D3E50] font-medium">
              ...
              <ScrollArea className="h-[500px]">
                {leaderboardData.allIndia.map((user) => (
                  <div
                    key={user.rank}
                    className="grid grid-cols-12 gap-4 p-4 border-b border-[rgba(91,179,179,0.15)] hover:bg-[#2D3E50] transition-colors"
                  >
                    ...
                    <div className="col-span-1 text-center hidden lg:flex items-center justify-center">
                      <Badge className="bg-[#C9A86C]/20 text-[#D97706] border-none">
              ...
              {/* User's Position */}
              <div className="grid grid-cols-12 gap-4 p-4 bg-gradient-to-r from-[#364A5E] to-[#2D3E50] border-t-2 border-[#5BB3B3]">
                <div className="col-span-1 flex items-center">
        ...
        <TabsContent value="rewards" className="space-y-6">
          {/* Coin Balance */}
          <Card className="bg-gradient-to-r from-[#364A5E] via-[#314458] to-[#2D3E50] border-[rgba(91,179,179,0.22)] shadow-xl">
            <CardContent className="p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-2xl bg-[#364A5E] shadow-lg flex items-center justify-center border border-[#C9A86C]">
              ...
              <div className="flex gap-2">
                <Button variant="outline" className="border-[#C9A86C]/55 text-[#C9A86C] hover:bg-[#C9A86C]/12 hover:text-[#E8E0D5]">
                    ...
                    <Button
                      className={`w-full shadow-lg ${
                        userCoins >= reward.price
                          ? "bg-gradient-to-r from-[#5BB3B3] to-[#4A9E9E] hover:from-[#4A9E9E] hover:to-[#3F6F8A]"
                          : "bg-[#3A4D5F] text-[#94A3B8] cursor-not-allowed"
                      }`}
            ...
            <CardContent className="pt-4">
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-center gap-3 p-4 rounded-xl bg-[#2D3E50] border border-[rgba(91,179,179,0.15)] hover:shadow-lg transition-all"
                  >
                    <div 
