  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="text-center py-8">
        ...
        <p className="text-gray-400">Portal Hypertension & Complications</p>
      </div>

      {/* Score Card */}
      <Card className="bg-gradient-to-br from-purple-500/20 to-cyan-500/20 border-purple-500/30 p-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1 grid grid-cols-2 gap-4">
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 text-center">
              ...
              <p className="text-sm text-gray-400">Avg per Q</p>
            </div>
            <div className="bg-gray-800/50 rounded-xl p-4 text-center">
              <Brain className="w-6 h-6 text-orange-400 mx-auto mb-2" />
              <p className="text-2xl font-bold text-white">{totalCount - correctCount}</p>
            ...
            <div className="flex gap-2">
              {(["all", "correct", "incorrect"] as const).map((f) => (
                <Button
                  ...
                  size="sm"
                  onClick={() => setFilter(f)}
                  className={filter === f ? "bg-purple-600" : "border-gray-600 text-gray-300"}
                >
      ...
      <Card className="bg-gray-800/30 border-gray-700 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <button className="p-4 rounded-lg border border-gray-700 hover:border-purple-500/50 transition-colors text-left group">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 rounded-lg bg-yellow-500/20">
                <Brain className="w-5 h-5 text-yellow-400" />
              </div>
              <span className="font-medium text-white">Review Weak Topics</span>
            </div>
          ...
          <button className="p-4 rounded-lg border border-gray-700 hover:border-purple-500/50 transition-colors text-left group">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="font-medium text-white">Read Source Material</span>
            </div>
            <p className="text-sm text-gray-400">
