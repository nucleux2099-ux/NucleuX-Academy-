      ...
      <div className="flex flex-col lg:flex-row gap-6">
          ...
          <Card className="bg-[#364A5E] border-[rgba(91,179,179,0.15)] mb-6">
            <CardHeader className="pb-3">
              <CardTitle className="text-lg flex items-center gap-2 text-[#E8E0D5]">
                <StickyNote className="w-5 h-5 text-[#C9A86C]" />
                My Notes
              ...
              <div className="flex gap-2 mb-4">
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-[#3A4D5F] border border-[rgba(91,179,179,0.15)] rounded-lg text-[#E8E0D5] placeholder-[#6B7280] focus:border-[#C9A86C] focus:outline-none"
                  />
                  <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[#6B7280]">
                    @ {formatTime(currentTime)}
                  </span>
                </div>
                <Button onClick={addNote} className="bg-[#C9A86C] hover:bg-[#5BB3B3] text-white">
                  ...
                  {notes.map((note) => (
                    ...
                    >
                      <button
                        ...
                        className="text-[#C9A86C] font-mono text-sm hover:underline shrink-0"
                      >
        ...
        {showChapters && (
          <aside className="w-full lg:w-80 shrink-0 space-y-6">
            ...
            {/* Ask ATOM */}
            <Card className="bg-gradient-to-br from-[rgba(91,179,179,0.15)] to-[rgba(201,168,108,0.12)] border-[rgba(91,179,179,0.2)]">
              <CardContent className="p-4">
