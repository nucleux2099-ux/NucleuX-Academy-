    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-950/30 p-12 flex-col justify-between border-r border-white/10">
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="text-2xl font-bold text-[#E8E0D5]">
            NucleuX Academy
          </span>
        </Link>
        ...
        <div className="space-y-6">
          <h1 className="text-4xl font-bold leading-tight text-[#E8E0D5]">
            ...
            <br />
            Grow <span className="text-[#C9A86C]">Exponentially</span>.
          </h1>
          ...
          <div className="grid grid-cols-2 gap-y-6 gap-x-8 pt-4">
            ...
            <div>
              <div className="text-3xl font-bold text-[#C9A86C]">Classroom</div>
              <div className="text-sm text-[#A0B0BC]">Teaching + notes</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#5BB3B3]">Training centre</div>
              <div className="text-sm text-[#A0B0BC]">Practice + feedback</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#C9A86C]">Common Room</div>
              <div className="text-sm text-[#A0B0BC]">Debate + community</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#5BB3B3]">Arena</div>
              <div className="text-sm text-[#A0B0BC]">Competitive mastery</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#C9A86C]">Backstage</div>
              <div className="text-sm text-[#A0B0BC]">Confidence calibration</div>
            </div>
          </div>
        </div>
