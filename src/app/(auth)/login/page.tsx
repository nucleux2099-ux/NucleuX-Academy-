...
function LoginForm() {
  ...
  useEffect(() => {
    if (callbackError) {
      setError(callbackErrorDescription || 'Google sign in failed. Please try again.');
    }
        ...
        <CardContent className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-[#A0B0BC]">
                Email
              </label>
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#6B7A88]" />
                <Input
                  type="email"
                  ...
                  className="pl-10 h-12 bg-white/5 border-white/10 focus:border-[#5BB3B3] focus:ring-[#5BB3B3]/20 text-[#E8E0D5] placeholder:text-[#6B7A88]"
                  required
                  disabled={isLoading}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#6B7A88]" />
                <Input
                  ...
                  className="pl-10 pr-10 h-12 bg-white/5 border-white/10 focus:border-[#5BB3B3] focus:ring-[#5BB3B3]/20 text-[#E8E0D5] placeholder:text-[#6B7A88]"
                  required
                  disabled={isLoading}
                />
                <button
