    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <section className="max-w-7xl mx-auto px-6 pt-10 sm:pt-16 pb-8 sm:pb-10">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-5 text-4xl sm:text-6xl font-bold text-[#E8E0D5] leading-tight">Campus rooms — organized.</h1>
          <p className="mt-5 text-lg text-[#A0B0BC]">If you want the full “slide deck” experience, go back to the tour page.</p>
