...
G6Pd Deficiency is a high-yield Hematology topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of G6Pd Deficiency
...
*Common mnemonics for G6Pd Deficiency — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| G6Pd Deficiency | Classic presentation |
