...
Blood Component Therapy is a high-yield Hematology topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of Blood Component Therapy
...
*Common mnemonics for Blood Component Therapy — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| Blood Component Therapy | Classic presentation |
