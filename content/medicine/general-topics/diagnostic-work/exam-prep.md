...
Diagnostic Workup is a high-yield General Medicine topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of Diagnostic Workup
...
*Common mnemonics for Diagnostic Workup — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| Diagnostic Workup | Classic presentation |
