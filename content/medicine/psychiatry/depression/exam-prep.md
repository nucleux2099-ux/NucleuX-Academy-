...
Depression is a high-yield Psychiatry topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of Depression
...
*Common mnemonics for Depression — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| Depression | Classic presentation |
