...
Pressure Ulcers is a high-yield Geriatrics topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of Pressure Ulcers
...
*Common mnemonics for Pressure Ulcers — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| Pressure Ulcers | Classic presentation |
