...
Systemic Parasitic Infections is a high-yield Infectious Diseases topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of Systemic Parasitic Infections
...
*Common mnemonics for Systemic Parasitic Infections — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| Systemic Parasitic Infections | Classic presentation |
