...
Atrial Fibrillation is a high-yield Cardiology topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of Atrial Fibrillation
...
*Common mnemonics for Atrial Fibrillation — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| Atrial Fibrillation | Classic presentation |
