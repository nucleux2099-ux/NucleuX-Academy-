...
Heart Block is a high-yield Cardiology topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of Heart Block
...
*Common mnemonics for Heart Block — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| Heart Block | Classic presentation |
