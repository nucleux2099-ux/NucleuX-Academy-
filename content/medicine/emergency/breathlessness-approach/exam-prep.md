...
Approach to Breathlessness is a high-yield Emergency Medicine topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of Approach to Breathlessness
...
*Common mnemonics for Approach to Breathlessness — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| Approach to Breathlessness | Classic presentation |
