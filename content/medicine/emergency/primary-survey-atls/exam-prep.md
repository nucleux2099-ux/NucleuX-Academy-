...
Primary Survey / ATLS is a high-yield Emergency Medicine topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of Primary Survey / ATLS
...
*Common mnemonics for Primary Survey / ATLS — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| Primary Survey / ATLS | Classic presentation |
