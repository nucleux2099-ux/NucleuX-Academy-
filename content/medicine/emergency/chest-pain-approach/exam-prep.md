...
Approach to Chest Pain is a high-yield Emergency Medicine topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of Approach to Chest Pain
...
*Common mnemonics for Approach to Chest Pain — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| Approach to Chest Pain | Classic presentation |
