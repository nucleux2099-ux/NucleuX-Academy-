...
Minimal Change Disease is a high-yield Nephrology topic. Focus on etiology, clinical features, diagnostic criteria, and management principles for exam preparation.

## High Yield Points

- ★ Know the definition and classification of Minimal Change Disease
...
*Common mnemonics for Minimal Change Disease — check standard textbooks for subject-specific memory aids.*
...
|-----------|---------------------------|
| Minimal Change Disease | Classic presentation |
